...
<h1 class="wp-block-heading has-inter-font-family"><?php esc_html_e('Latest Posts', 'riaco-theme');?></h1>
<!-- /wp:heading -->

<!-- wp:pattern {"slug":"riaco-theme/latest-10-posts"} /--></main>
<!-- /wp:group -->
