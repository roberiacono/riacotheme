...
<h2 class="wp-block-heading"><?php esc_html_e('Page Not Found', 'riaco-theme');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('The page you are looking for does not exist, or it has been moved. Please try searching using the form below.', 'riaco-theme');?></p>
<!-- /wp:paragraph -->
